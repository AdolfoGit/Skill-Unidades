...
const languageStrings = {
    ...
    es: {
        translation: {
            WELCOME_MESSAGE: 'Bienvenido al convertidor de unidades. ¿Qué te gustaría convertir?',
...
const ConvertidorIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let speakOutput = 'Convertidor Adolfo. ';
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Convertidor Adolfo. ' + requestAttributes.t('WELCOME_MESSAGE');
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Convertidor Adolfo. ' + requestAttributes.t('HELP_MESSAGE');
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Convertidor Adolfo. ' + requestAttributes.t('GOODBYE_MESSAGE');
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Convertidor Adolfo. ' + requestAttributes.t('FALLBACK_MESSAGE');
...
const IntentReflectorHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'Convertidor Adolfo. ' + requestAttributes.t('REFLECTOR_MESSAGE', intentName);
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = 'Convertidor Adolfo. ' + requestAttributes.t('ERROR_MESSAGE');
